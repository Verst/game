<div style="display:inline-block;width:calc(100% - 510px);">
	<?
	if(!empty($shmot)){?>
	<table width="100%">
	<?
		foreach($shmot as $row){
			...
			echo "<br>";
			echo "<span onclick='putOn(\"".$row->gid."\")'>Надеть</span>";
			echo "<br>";
			echo "Выкинуть";
			echo "</td><td width=\"100%\" valign=\"top\" style=\"border:1px solid #CCC;\">";
			echo "<b>".$row->name."</b> (".$row->dolg_min."/".$row->dolg_max.")";
			echo "<br><br>";
			echo "Требования:";
			echo "<br>";
